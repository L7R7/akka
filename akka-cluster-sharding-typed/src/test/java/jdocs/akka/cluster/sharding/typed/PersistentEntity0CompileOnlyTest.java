...
public class PersistentEntity0CompileOnlyTest {
  ...
  public static class BlogEntity extends PersistentBehavior<BlogCommand, BlogEvent, BlogState> {

    public BlogEntity(String entityId) {
      super(blogTypeKey.persistenceIdFrom(entityId));
    }
