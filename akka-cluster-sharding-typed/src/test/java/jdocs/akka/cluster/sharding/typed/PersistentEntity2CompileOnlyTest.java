...
import akka.cluster.sharding.typed.javadsl.PersistentEntity2;
import akka.cluster.sharding.typed.javadsl.ShardedPersistentEntity2;
...
public class PersistentEntity2CompileOnlyTest {
  ...
  public static class BlogService {
    ...
    public BlogService(ActorSystem<?> system) {
      ...
      sharding.start(
          ShardedPersistentEntity2.create(
    ...
    public CompletionStage<Done> addPost(String blogPostId, String title, String body) {
      EntityRef<BlogCommand> entityRef = sharding.entityRefFor(blogTypeKey, "blogPostId-123");
  ...
  public static class BlogEntity extends PersistentEntity2<BlogCommand, BlogEvent, BlogState> {
